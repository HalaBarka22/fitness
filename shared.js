    ...
    if (typeof data !== 'undefined' && data.success === true) {
      ...
      if (data.errors) {
        ...
        if ($errors.children().length > 0) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_errors').replaceWith(data.errors);
        }
      }
...
const ResizeHandler = function () {
  ...
  this.setWidth = function (position) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#floating_menubar').css('margin-' + this.left, jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_navigation').width() + jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_navigation_resizer').width()).css(this.left, 0).css({
      'position': 'fixed',
      'top': 0,
      'width': '100%',
      'z-index': 99
    }).append(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#server-breadcrumb')).append(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#topmenucontainer'));
...
function getAddIndexEventHandler() {
  return function (event) {
    event.preventDefault();
    var hadAddButtonHidden = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('fieldset').find('.add_fields').hasClass('hide');
    if (hadAddButtonHidden === false) {
      var rowsToAdd = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('fieldset').find('.slider').slider('value');
...
function showIndexEditDialog($outer) {
  ...
  $outer.find('.slider').slider({
    ...
    max: 16,
    slide: function (event, ui) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('fieldset').find('input[type=submit]').val(window.sprintf(window.Messages.strAddToIndex, ui.value));
    }
  });
...
function onloadRecentFavoriteTables() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
    ...
    type: 'POST',
    data: {
      'favoriteTables': (0,_functions_isStorageSupported_ts__WEBPACK_IMPORTED_MODULE_14__["default"])('localStorage') && typeof window.localStorage.favoriteTables !== 'undefined' ? window.localStorage.favoriteTables : '',
      'server': _common_ts__WEBPACK_IMPORTED_MODULE_3__.CommonParams.get('server'),
      'no_debug': true
    },
    success: function (data) {
...
function floatingMenuBar() {
  return function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#floating_menubar').css('margin-' + left, jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_navigation').width() + jquery__WEBPACK_IMPORTED_MODULE_0___default()('#pma_navigation_resizer').width()).css(left, 0).css({
      'position': 'fixed',
      'top': 0,
      'width': '100%',
      'z-index': 99
...
function indexTypeSelectionDialog(sourceArray, indexChoice, colIndex) {
  var $singleColumnRadio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input type="radio" id="single_column" name="index_choice"' + ' checked="checked">' + '<label for="single_column">' + window.Messages.strCreateSingleColumnIndex + '</label>');
  var $compositeIndexRadio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input type="radio" id="composite_index"' + ' name="index_choice">' + '<label for="composite_index">' + window.Messages.strCreateCompositeIndex + '</label>');
  var $dialogContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<fieldset class="pma-fieldset" id="advance_index_creator"></fieldset>');
